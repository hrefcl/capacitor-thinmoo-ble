...
public class ThinmooBlePlugin: CAPPlugin {
    ...
    @objc func open(_ call: CAPPluginCall) {
        ...
        implementation.open(devSn, miniEkey: miniEkey, value: value, connection_services: connection_services, services: services, characteristic_read: characteristic_read, characteristic_write: characteristic_write, plugin: self) { success in
